...
public class ModItems {
    ...
    //items
        //chunks
    public static final Item IRON_CHUNKS = new Item(new Item.Settings().group(ItemGroup.MATERIALS));
    public static final Item GOLD_CHUNKS = new Item(new Item.Settings().group(ItemGroup.MATERIALS));
    public static final Item DIAMOND_CHUNKS = new Item(new Item.Settings().group(ItemGroup.MATERIALS));
        //coins
